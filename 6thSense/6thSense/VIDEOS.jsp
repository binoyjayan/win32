...
<tr background=pink>
	...
	<BR>
        ...
        <center><input class=cho type=submit value=AUDIOS name=ig></center>
        </form>
	</td>
	...
	<td BGCOLOR=#93C2d3 cellspacing="10" cellpadding="10">
        ...
        <center><input class=cho1 type=submit value=VIDEOS name=ig></center>
	</td>
...
<TR>
	<TD bgcolor="#93C2d3">
	<INPUT TYPE=TEXT size=50 NAME=query value='Video Query'>
	</TD>
	<td bgcolor="#93C2d3">
