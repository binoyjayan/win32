...
<%     
       ...
       Indexer index=new Indexer();
        ...
        if(type.equals("pr"))
            r=index.execute("AUDIO",uquery,1);
        else
            r=index.execute("AUDIO",uquery,0);
        ...
        while(r.next())
        {
            if(i==count)
                ...
                if(flag==1)
                {
                    ...
                    out.println("<font color='blue' size=6 type='Informal Roman'><b><i>Audio links for you...</i></b></font> <br><br>");
                    heading=0;
                    }
                    link=r.getString(1);
                url=r.getString(2);
