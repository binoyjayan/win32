...
<tr background=pink>
	<td BGCOLOR=#93C2d3 cellspacing="10" cellpadding="10">
        ...
        <center><input class=cho1 type=submit value=WEB name=ig></center>
	</td>
	...
	<form action="IMAGES.jsp" >
        ...
        <br><center><input class=cho type=submit value=IMAGES name=ig></center></form>
	</td>
...
<TR>
	...
	<TD bgcolor="#93C2d3">
	<INPUT TYPE=TEXT size=50 NAME=query value='Web Query'>
	</TD>
	<td bgcolor="#93C2d3">
