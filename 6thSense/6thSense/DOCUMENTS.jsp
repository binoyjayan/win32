...
<tr background=pink>
	...
	<form action="AUDIOS.jsp" >
        ...
        <center><br><input class=cho type=submit value=AUDIOS name=ig></center></form>
	</td>
	...
	<td BGCOLOR=#93C2d3 cellspacing="10" cellpadding="10">
        ...
        <center><input class=cho1 type=submit value=DOCUMENTS name=ig></center>
	</td>
</tr>
</table>
<br>
<FORM ACTION="documentsearch.jsp">
...
<TR>
	<TD bgcolor="#93C2d3">
	<INPUT TYPE=TEXT size=50 NAME=query value='document Query'>
	</TD>
	<td bgcolor="#93C2d3">
