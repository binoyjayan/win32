...
<%     
       ...
       Indexer index=new Indexer();
        ...
        if(type.equals("pr"))
            r=index.execute("HTML",uquery,1);
        else
            r=index.execute("HTML",uquery,0);
                ...
                content=r.getString(5);
                        ...
                        while(SPACECOUNT<10)
                       {
                         ...
                         SPACECOUNT++;
                            ...
                            out.println("<font color='blue' size=6 type='Informal Roman'><b><i>Web pages for you...</i></b></font> <br><br>");
                        SPACECOUNT=0;
                        heading=0;
                  ...
                  out.println("<font color=blue size=3>"+content+"</font><br><br>");
                        count++;
                        curcount++;
